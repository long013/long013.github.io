...
1) Wang, H., **Long, W.**, Chadwick, D., Velthof, G. L., Oenema, O., Ma, W., ... & Zhang, F. (2020). [**Can dietary manipulations improve the productivity of pigs with lower environmental and economic cost? A global meta-analysis**](https://www.sciencedirect.com/science/article/pii/S0167880919303640?via%3Dihub). ***Agriculture, Ecosystems & Environment (SCI Q1; IF=6.0)***, 289, 106748.             
2) Wang, H., **Long, W.**, Chadwick, D., Zhang, X., Zhang, S., Piao, X., & Hou, Y. (2022). [**Dietary acidifiers as an alternative to antibiotics for promoting pig growth performance: A systematic review and meta-analysis**](https://www.sciencedirect.com/science/article/pii/S0377840122001183?via%3Dihub). ***Animal Feed Science and Technology (SCI Q1; IF=2.5)***, 115320.              
3) Tong, B., Zhang, L., Hou, Y., Oenema, O., **Long, W.**, Velthof, G. L., ... & Zhang, F. (2020). [**Lower pork consumption and technological change in feed production can reduce the pork supply chain environmental footprint in China**](https://www.nature.com/articles/s43016-022-00640-6). ***Nature Food (SCI Q1; IF=23.6)***, 1-10.
4) 
